...
var cleanTitle_1 = require("./helpers/cleanTitle");
...
function getVideosFromDesc(yt_id) {
    return __awaiter(this, void 0, void 0, function () {
        var videos, desc, i, content, elt, title, artist, videosSearched, y, track, original_title_lower, _a, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    _b.label = 4;
                case 4:
                    if (!(y < videosSearched.videos.length)) return [3 /*break*/, 8];
                    track = videosSearched.videos[y];
